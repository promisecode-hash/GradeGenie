...
public interface IStudentAcademicService
{
    ...
    Task<TargetGradeResponse> CalculateTargetGradeAsync(TargetGradeRequest request, CancellationToken cancellationToken = default);
    Task<AcademicPlanResponse> CreateAcademicPlanAsync(AcademicPlanRequest request, CancellationToken cancellationToken = default);
